...
const OrderCard = memo(
  ({ order, onPress, variant = 'list' }: OrderCardProps) => {
    ...
    const Icon =
      order.status === 1 ? AlertTriangle : isImage ? ImageIcon : FileText;
        ...
        >
          ...
          <View style={styles.homeContent}>
            ...
            <View style={styles.homeBottomRow}>
              <Text
                style={[styles.homeSubtitle, { color: colors.textMuted }]}
                numberOfLines={1}
              >
    ...
    return (
      ...
      >
        <View style={styles.listTop}>
          <View
            style={[styles.listIconBox, { backgroundColor: colors.surface }]}
          >
            <Icon
