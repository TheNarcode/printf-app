    ...
    <View style={[styles.compactSeg, { backgroundColor: colors.surface }]}>
      {options.map(opt => {
        ...
        return (
          ...
          >
            <Text weight={active ? 'semibold' : 'medium'} style={[styles.compactSegText, { color: active ? colors.text : colors.textSecondary }]}>
              {opt.label}
            </Text>
          </TouchableOpacity>
        );
      ...
      <View style={styles.settingsSection}>
        ...
        <View style={[styles.settingsCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <View style={[styles.pageRangeSection, { borderTopColor: colors.borderLight }]}>
            ...
            />
            {pageRangeError ? (
              <Text weight="medium" style={{ fontSize: moderateScale(11), color: colors.danger, marginTop: scale(4) }}>
                {pageRangeError}
              </Text>
            ) : null}
          </View>
        ...
        <View style={styles.modalOverlay}>
          ...
          <View style={[styles.actionSheet, { backgroundColor: colors.card, paddingBottom: insets.bottom + scale(20) }]}>
            <View style={styles.sheetHeader}>
              <Text weight="bold" style={[styles.sheetTitle, { color: colors.text }]}>Duplex / Sides</Text>
            ...
            {SIDES_OPTIONS.map(opt => {
              ...
              return (
                ...
                >
                  <Text weight={active ? 'semibold' : 'medium'} style={[styles.sheetOptionText, { color: active ? colors.primary : colors.text }]}>
                    {opt.label}
                  </Text>
                  {active && (
...
const styles = StyleSheet.create({
  ...
  settingRowLabel: { fontSize: moderateScale(13) },
  ...
  compactSegText: { fontSize: moderateScale(11) },
  ...
  dropdownValue: { fontSize: moderateScale(12), flex: 1, marginRight: scale(6) },
  ...
  stepValueText: { fontSize: moderateScale(13) },
  ...
  pageRangeHint: { fontSize: moderateScale(11) },
  pageRangeInput: { borderWidth: 1, borderRadius: scale(8), paddingHorizontal: scale(14), paddingVertical: scale(12), fontSize: moderateScale(14) },
  ...
  sheetTitle: { fontSize: moderateScale(16) },
  ...
  sheetOptionText: { fontSize: moderateScale(14) },
