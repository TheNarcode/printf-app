  ...
  return (
    <View style={[styles.container, {backgroundColor: colors.background}]}>
      ...
      <ScrollView
            ...
            {THEME_OPTIONS.map(({key, label, Icon}) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.themePill,
                    active && [styles.themePillActive, {backgroundColor: colors.card}],
                  ]}>
        ...
        <Text style={[styles.version, {color: colors.textMuted}]}>printf v1.0.0</Text>
      </ScrollView>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  // Theme Pill Bar
  themePillBar: {flexDirection: 'row', borderRadius: scale(10), padding: scale(3)},
  themePill: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: scale(5), paddingVertical: scale(10), borderRadius: scale(8),
  },
  themePillActive: {
  ...
  version: {fontSize: moderateScale(10), textAlign: 'center', marginTop: scale(16)},
});
