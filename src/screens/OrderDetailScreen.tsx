      ...
      >
        <View style={styles.receiptContainer}>
          ...
          <View style={[styles.receiptBody, { backgroundColor: slipBg }]}>
              ...
              {order.files.map(f => {
                ...
                return (
                  <View key={f.file.id} style={styles.itemBlock}>
                    <View style={styles.columnHeader}>
                      <Text style={[styles.itemName, { color: colors.text }]} numberOfLines={1}>{f.file.name}</Text>
            ...
            <View style={styles.totalLine}>
              <Text style={[styles.totalLabel, { color: colors.textSecondary }]}>STATUS</Text>
              <Text style={[styles.totalValue, { color: colors.textSecondary }]}>{order.paid ? 'Payment Cleared' : 'Payment Pending'}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  separatorText: { fontFamily: 'GeistMono-Regular', fontSize: moderateScale(10), lineHeight: moderateScale(14), letterSpacing: 0 },
  ...
  storeName: { fontFamily: 'GeistMono-Bold', fontSize: moderateScale(18), letterSpacing: 1.5, marginBottom: scale(2) },
  ...
  statusPillText: { fontFamily: 'GeistMono-Bold', fontSize: moderateScale(11), letterSpacing: 1.5 },
  ...
  colPrice: { width: scale(56), fontFamily: 'GeistMono-Regular', fontSize: moderateScale(10), textAlign: 'right' },
  ...
  itemPriceCol: { width: scale(56), fontFamily: 'GeistMono-Regular', fontSize: moderateScale(11), textAlign: 'right' },
